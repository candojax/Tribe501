...
$config['jcartPath']              = 'http://revoservices.com/portal/jcart/';

// Path to your checkout page
$config['checkoutPath']           = 'index.php?action=checkout';
...
$config['paypal']['id']           = 'jbrown@candojax.org';
...
$config['text']['emptyMessage']   = 'Cart is empty';    // Your cart is empty!
